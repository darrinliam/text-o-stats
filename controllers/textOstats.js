...
const wordCalc = (inData) => {
	...
	*/
	...
	let outData = { success, wordCount, sentenceCount, avgWordsPerSentence, sentenceLenStdDev, 
	                longestWords, longestWordLen, maxWordFreq, avgWordLength, avgConseqSentLenDif };
	return outData;
}
